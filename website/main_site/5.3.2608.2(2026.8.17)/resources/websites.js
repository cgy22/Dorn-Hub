...
const categories = {
	...
	support: { name: "网站支持", icon: "fa-envelope", order: 5},
    ancient: { name: "远古时期（这些网站已暂停支持）", icon: "fa-fossil", order: 6 },
...
const websites = [
    ...
    { name: "人口管理部-国民身份管理局", url: "https://dornhub.eu.org/gov-services/id/index.html", icon: "fa-id-card", category: "official" },
    ...
    { name: "内政部-选举事务局", url: "http://election.dorn.rf.gd", icon: "fa-vote-yea", category: "official" },
	{ name: "福利部-最低保障局", url: "https://dornhub.eu.org/gov-services/welfare-dep.html", icon: "fas fa-heart", category: "official" },
    ...
    { name: "𣿅国国运模拟器-𣿅国历史上第一款电子游戏", url: "https://dornhub.github.io/valeriette/donh-destiny-forecast.html", icon: "fa-chart-line", category: "entertainment" },
    {
        type: 'folder',
        name: "𣿅国太空大战模拟器",
        icon: "fa-plane",
        ...
        children: [
            { name: "𣿅国太空大战模拟器", url: "https://dornhub.eu.org/games/plane-war/plane-war.html", icon: "fa-plane", category: "entertainment" },
            { name: "𣿅国太空大战模拟器-破解版", url: "https://dornhub.eu.org/games/plane-war/plane-war-cracked.html", icon: "fa-plane", category: "entertainment" },
            { name: "𣿅国太空大战模拟器-困难版", url: "https://dornhub.eu.org/games/plane-war/plane-war-hard.html", icon: "fa-plane", category: "entertainment" },
            { name: "飞机大战-C++版（前往GitHub下载）", url: "https://github.com/DornGames/PlaneWar/releases", icon: "fab fa-github", category: "entertainment" }
        ]
    },
	{ name: "逃离大香蕉（前往GitHub下载）", url: "https://github.com/DornGames/Escape-the-Big-Banana/releases", icon: "fab fa-github", category: "entertainment" },
	//{ name: "飞机大战（前往GitHub下载）", url: "https://github.com/DornGames/PlaneWar/releases", icon: "fab fa-github", category: "entertainment" }, // 已移入文件夹
    ...
    { name: "𣿅国名人堂-2站", url: "https://cgy22.github.io/dhof/", icon: "fa-star", category: "culture" },
	{
	    ...
	    category: "culture",
	    children: [
	        { name: "瓦莱希雅大辞典3", url: "https://dorngames.github.io/ValenciaBangswp-V3/src/index.html", icon: "fa-book-open", category: "culture" },
	        { name: "瓦莱希雅大辞典2-1站", url: "http://valencia.dorn.rf.gd", icon: "fa-book-open", category: "culture" },
	        { name: "瓦莱希雅大辞典2-2站", url: "https://cgy22.github.io/valencia/", icon: "fa-book-open", category: "culture" }
	    ]
	},
	...
	{ name: "隐私政策", url: "https://dornhub.eu.org/privacy-policy.html", icon: "fas fa-shield-alt", category: "support" },
	{ name: "使用条款", url: "https://dornhub.eu.org/terms.html", icon: "fas fa-file-contract", category: "support" },
	{ name: "Cookie政策", url: "https://dornhub.eu.org/cookie-policy.html", icon: "fas fa-cookie-bite", category: "support" },
	{ name: "免责声明", url: "https://dornhub.eu.org/disclaimer.html", icon: "fas fa-exclamation-triangle", category: "support" },
	{ name: "联系我们", url: "https://dornhub.eu.org/contact.html", icon: "fas fa-envelope", category: "support" },
	{ name: "关于我们", url: "https://dornhub.eu.org/about.html", icon: "fas fa-user", category: "support" },
	{ name: "本网站的GitHub仓库", url: "https://github.com/cgy22/Dorn-Hub", icon: "fab fa-github", category: "support" },
	{ name: "子团队DornGames", url: "https://github.com/DornGames", icon: "fab fa-github", category: "support" },
...
// 递归展开文件夹中的所有子网站（用于搜索等功能）
function flattenWebsites(sites) {
    const result = [];
    for (const site of sites) {
        if (site.type === 'folder' && site.children) {
            // 递归展开子项
            const children = flattenWebsites(site.children);
...
// 获取所有可固定的网站（展开文件夹，只返回普通网站）
function getPinnableWebsites() {
    return flattenWebsites(websites);
}